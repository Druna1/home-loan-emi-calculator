...
def calculate_emi_and_schedule(home_value, down_payment_percentage, interest_rate, loan_tenure_years, 
    ...
    colors = ['#B0C4DE', '#FFB6C1', '#4169E1']  # Light Grey for Principal, Pastel Pink for Extra Payment, Royal Blue for Interest
    ...
    ax_bar.bar(year, principal_paid, label='Principal Paid', color='#B0C4DE', alpha=0.7, width=0.4, align='center')
    ax_bar.bar(year, interest_paid, label='Interest Paid', color='#4169E1', alpha=0.7, width=0.4, align='center', bottom=principal_paid)
